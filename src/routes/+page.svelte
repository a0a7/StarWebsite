...
<main class="justify-between items-center l-0">
    <div class="flex flex-col h-[100vh] pt-2 md:pt-4 w-full">
        ...
        <span class="w-full text-center justify-center flex items-center md:text-center font-bold font-mastery text-fuchsia-50 pb-4 md:pb-8">
            <a class="mr-6 tooltip-social" data-text="@syslev" href="https://discord.com/users/366213124765777933" target="_blank" rel="noopener noreferrer">
            ...
            <a class="tooltip-discord" data-text="@syslev" href="https://github.com/syslev" target="_blank" rel="noopener noreferrer">
